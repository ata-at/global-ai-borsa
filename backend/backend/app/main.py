...
# YAHOO BULUT SUNUCU ENGELLERİNİ YFINANCE MOTORUYLA AŞAN SINIF
class GlobalFinancialData:
    async def time_series(self, symbol: str):
        try:
            ...
            # Kriptolar için standart formata dönüştür
            ...
            # yfinance kütüphanesini asenkron olarak arka planda çalıştırıyoruz (Engellenmez)
            ...
            for index, row in hist.iterrows():
                # DÜZELTME: Arayüzün (Frontend) beklediği standart boşluklu kısa tarih formatı
                # Örn: '2026-09-12 00:00:00' formatına zorluyoruz. Desen (pattern) hatasını kesin çözer.
