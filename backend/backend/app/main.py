...
# ARTIK YAHOO YA DA TWELVE DATA YOK; DOĞRUDAN RESMİ BİNANCE APISİNE BAĞLANIYORUZ
class BinanceData:
    async def time_series(self, symbol: str, interval="1d", limit=100):
        try:
            # Gelen sembolü temizle (Örn: 'BINANCE:BTCUSD' veya 'BTC-USD' gelirse 'BTCUSDT' yap)
            if ":" in symbol:
            ...
            # Binance verilerini ChatGPT'nin yazdığı analyze fonksiyonuna uygun formata çeviriyoruz
            formatted_values = []
            for item in data:
